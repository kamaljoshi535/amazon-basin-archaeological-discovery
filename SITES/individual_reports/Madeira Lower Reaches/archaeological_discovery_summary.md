...
- **Site Name**: Madeira Lower Reaches
- **Primary Coordinates**: -3.500000, -59.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Lower Madeira basin exploration
- **Analysis Date**: 2025-06-29 19:29:32
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Madeira Lower Reaches represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-3.500000, -59.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-3.509009, -59.009009) = **18.1%** probability
3. **North**: (-3.509009, -59.000000) = **16.7%** probability
4. **Northeast**: (-3.509009, -58.990991) = **16.1%** probability
5. **West**: (-3.500000, -59.009009) = **12.6%** probability
6. **East**: (-3.500000, -58.990991) = **15.4%** probability
7. **Southwest**: (-3.490991, -59.009009) = **19.8%** probability
8. **South**: (-3.490991, -59.000000) = **7.7%** probability
9. **Southeast**: (-3.490991, -58.990991) = **16.9%** probability
...
- **Cultural Context**: Lower Madeira basin exploration
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Lower Madeira basin exploration
- **Site Category**: discovery_target (discovery_potential priority)
...
**Hydro Management**: 0.850 (High) [WATER] REAL
...
- **Confidence Enhancement**: 3.042 → 1.000 (+0.109 adjustment)
...
- **Overview_Map_Map**: `Madeira_Lower_Reaches_archaeological_overview_map_20250629_192932.html`
- **Method_Map_Map**: `Madeira_Lower_Reaches_method_analysis_map_20250629_192932.html`
- **Evidence_Map_Map**: `Madeira_Lower_Reaches_evidence_documentation_map_20250629_192932.html`
- **3D_Surface_Map**: `Madeira_Lower_Reaches_3d_terrain_surface_20250629_192932.html`
- **Topographic_Contours_Map**: `Madeira_Lower_Reaches_topographic_contours_20250629_192932.html`
...
4. **Hydro Management (85.0%)**: Water management systems analyzed
...
**Key Findings**:
- **Cultural Significance**: Lower Madeira basin exploration
...
- Timestamp verification: 2025-06-29T19:29:32.118488

## AI-Generated Discovery Narrative

### The Digital Archaeological Investigation

**The Analysis Begins**: Using artificial intelligence and comprehensive data sources, we conducted a systematic archaeological investigation of the Amazon Basin. At coordinates -3.500000, -59.000000, our AI-powered system analyzed promising indicators requiring detailed assessment.
