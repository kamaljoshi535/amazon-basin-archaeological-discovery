...
- **Site Name**: Andes Foothills East
- **Primary Coordinates**: -10.000000, -75.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Eastern Andean foothills
- **Analysis Date**: 2025-06-29 20:40:44
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Andes Foothills East represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-10.000000, -75.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-10.009009, -75.009009) = **18.1%** probability
3. **North**: (-10.009009, -75.000000) = **16.7%** probability
4. **Northeast**: (-10.009009, -74.990991) = **16.1%** probability
5. **West**: (-10.000000, -75.009009) = **12.6%** probability
6. **East**: (-10.000000, -74.990991) = **15.4%** probability
7. **Southwest**: (-9.990991, -75.009009) = **19.8%** probability
8. **South**: (-9.990991, -75.000000) = **7.7%** probability
9. **Southeast**: (-9.990991, -74.990991) = **16.9%** probability
...
- **Archaeological Period**: Potential montane settlements
- **Cultural Context**: Eastern Andean foothills
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Eastern Andean foothills
- **Site Category**: discovery_target (discovery_potential priority)
...
**Geometric Analysis**: 0.762 (High) [REAL]
- *Detects artificial geometric patterns like roads, enclosures, and plazas using Hough line detection*
- **Calculation**: 12,382 Hough lines → Amazon-adaptive scaling (baseline=15,000.0) → 0.762
- **Archaeological Interpretation**: Geometric signatures detected - 12,382 Hough lines indicate potential artificial modifications

**DEM/LiDAR Analysis**: 0.477 (Medium) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.477
...
**Spectral Analysis**: 0.221 (Low) [REAL]
...
**Hydro Management**: 0.945 (High) [WATER] REAL
...
- **Confidence Enhancement**: 3.048 → 1.000 (-0.141 adjustment)
...
- **Working Satellite URL**: https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/MODIS_Terra_CorrectedReflectance_TrueColor/default/2024-07-22/250m/6/33/18.jpg

## Generated Visualizations
- **Overview_Map_Map**: `Andes_Foothills_East_archaeological_overview_map_20250629_204044.html`
- **Method_Map_Map**: `Andes_Foothills_East_method_analysis_map_20250629_204044.html`
- **Evidence_Map_Map**: `Andes_Foothills_East_evidence_documentation_map_20250629_204044.html`
- **3D_Surface_Map**: `Andes_Foothills_East_3d_terrain_surface_20250629_204044.html`
- **Topographic_Contours_Map**: `Andes_Foothills_East_topographic_contours_20250629_204044.html`
...
1. **Geometric Analysis (76.2%)**: Artificial landscape modifications detected
...
4. **Hydro Management (94.5%)**: Water management systems analyzed

**Supporting Evidence**:
- **DEM/LiDAR (47.7%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Eastern Andean foothills
- **Pattern Analysis**: 12,382 geometric features analyzed
