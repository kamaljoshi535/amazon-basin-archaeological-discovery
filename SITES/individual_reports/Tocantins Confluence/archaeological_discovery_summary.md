...
- **Site Name**: Tocantins Confluence
- **Primary Coordinates**: -4.500000, -49.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Tocantins-Amazon confluence
- **Analysis Date**: 2025-06-29 19:18:13
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Tocantins Confluence represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-4.500000, -49.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-4.509009, -49.009009) = **18.1%** probability
3. **North**: (-4.509009, -49.000000) = **16.7%** probability
4. **Northeast**: (-4.509009, -48.990991) = **16.1%** probability
5. **West**: (-4.500000, -49.009009) = **12.6%** probability
6. **East**: (-4.500000, -48.990991) = **15.4%** probability
7. **Southwest**: (-4.490991, -49.009009) = **19.8%** probability
8. **South**: (-4.490991, -49.000000) = **7.7%** probability
9. **Southeast**: (-4.490991, -48.990991) = **16.9%** probability
...
- **Archaeological Period**: Potential strategic location
- **Cultural Context**: Tocantins-Amazon confluence
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Tocantins-Amazon confluence
- **Site Category**: discovery_target (discovery_potential priority)
...
**DEM/LiDAR Analysis**: 0.487 (Medium) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.487
...
- **Confidence Enhancement**: 2.842 → 1.000 (+0.109 adjustment)
...
- **Overview_Map_Map**: `Tocantins_Confluence_archaeological_overview_map_20250629_191813.html`
- **Method_Map_Map**: `Tocantins_Confluence_method_analysis_map_20250629_191813.html`
- **Evidence_Map_Map**: `Tocantins_Confluence_evidence_documentation_map_20250629_191813.html`
- **3D_Surface_Map**: `Tocantins_Confluence_3d_terrain_surface_20250629_191813.html`
- **Topographic_Contours_Map**: `Tocantins_Confluence_topographic_contours_20250629_191813.html`
...
**Supporting Evidence**:
- **DEM/LiDAR (48.7%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Tocantins-Amazon confluence
...
- Timestamp verification: 2025-06-29T19:18:13.697310

## AI-Generated Discovery Narrative

### The Digital Archaeological Investigation

**The Analysis Begins**: Using artificial intelligence and comprehensive data sources, we conducted a systematic archaeological investigation of the Amazon Basin. At coordinates -4.500000, -49.000000, our AI-powered system analyzed promising indicators requiring detailed assessment.
