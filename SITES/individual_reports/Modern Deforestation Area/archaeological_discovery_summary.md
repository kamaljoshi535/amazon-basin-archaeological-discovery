...
- **Site Name**: Modern Deforestation Area
- **Primary Coordinates**: -8.000000, -60.000000 (Selected from archaeological literature)
- **Coordinate Source**: Control analysis
- **Ground Truth Validation**: Validated against Control site - modern disturbance
- **Analysis Date**: 2025-06-29 18:43:40
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: MONITOR

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Modern Deforestation Area represents a control_site site selected using our multi-method analysis system.

**Site Category**: control_site - control_validation priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-8.000000, -60.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-8.009009, -60.009009) = **18.1%** probability
3. **North**: (-8.009009, -60.000000) = **16.7%** probability
4. **Northeast**: (-8.009009, -59.990991) = **16.1%** probability
5. **West**: (-8.000000, -60.009009) = **12.6%** probability
6. **East**: (-8.000000, -59.990991) = **15.4%** probability
7. **Southwest**: (-7.990991, -60.009009) = **19.8%** probability
8. **South**: (-7.990991, -60.000000) = **7.7%** probability
9. **Southeast**: (-7.990991, -59.990991) = **16.9%** probability
...
- **Archaeological Period**: Recent deforestation area
- **Cultural Context**: Control site - modern disturbance
- **Archaeological Evidence**: No archaeological evidence expected
- **Historical Significance**: Control site - modern disturbance
- **Site Category**: control_site (control_validation priority)
- **Academic References**: Control analysis
...
**Geometric Analysis**: 0.758 (High) [REAL]
- *Detects artificial geometric patterns like roads, enclosures, and plazas using Hough line detection*
- **Calculation**: 11,144 Hough lines → Amazon-adaptive scaling (baseline=15,000.0) → 0.758
- **Archaeological Interpretation**: Geometric signatures detected - 11,144 Hough lines indicate potential artificial modifications

**DEM/LiDAR Analysis**: 0.501 (High) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.501
...
- **Confidence Enhancement**: 2.942 → 1.000 (+0.109 adjustment)
...
- **Working Satellite URL**: https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/MODIS_Terra_CorrectedReflectance_TrueColor/default/2024-07-15/250m/6/33/21.jpg

## Generated Visualizations
- **Overview_Map_Map**: `Modern_Deforestation_Area_archaeological_overview_map_20250629_184340.html`
- **Method_Map_Map**: `Modern_Deforestation_Area_method_analysis_map_20250629_184340.html`
- **Evidence_Map_Map**: `Modern_Deforestation_Area_evidence_documentation_map_20250629_184340.html`
- **3D_Surface_Map**: `Modern_Deforestation_Area_3d_terrain_surface_20250629_184340.html`
- **Topographic_Contours_Map**: `Modern_Deforestation_Area_topographic_contours_20250629_184340.html`
...
1. **Geometric Analysis (75.8%)**: Artificial landscape modifications detected
...
**Supporting Evidence**:
- **DEM/LiDAR (50.1%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Control site - modern disturbance
- **Pattern Analysis**: 11,144 geometric features analyzed
