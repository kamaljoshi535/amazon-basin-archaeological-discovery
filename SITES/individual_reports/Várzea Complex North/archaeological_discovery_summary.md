...
- **Site Name**: Várzea Complex North
- **Primary Coordinates**: -2.000000, -57.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Northern várzea exploration
- **Analysis Date**: 2025-06-29 20:52:08
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Várzea Complex North represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-2.000000, -57.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-2.009009, -57.009009) = **18.1%** probability
3. **North**: (-2.009009, -57.000000) = **16.7%** probability
4. **Northeast**: (-2.009009, -56.990991) = **16.1%** probability
5. **West**: (-2.000000, -57.009009) = **12.6%** probability
6. **East**: (-2.000000, -56.990991) = **15.4%** probability
7. **Southwest**: (-1.990991, -57.009009) = **19.8%** probability
8. **South**: (-1.990991, -57.000000) = **7.7%** probability
9. **Southeast**: (-1.990991, -56.990991) = **16.9%** probability
...
- **Cultural Context**: Northern várzea exploration
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Northern várzea exploration
- **Site Category**: discovery_target (discovery_potential priority)
...
**DEM/LiDAR Analysis**: 0.506 (High) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.506
...
- **Confidence Enhancement**: 3.001 → 1.000 (+0.109 adjustment)
...
- **Overview_Map_Map**: `Várzea_Complex_North_archaeological_overview_map_20250629_205208.html`
- **Method_Map_Map**: `Várzea_Complex_North_method_analysis_map_20250629_205208.html`
- **Evidence_Map_Map**: `Várzea_Complex_North_evidence_documentation_map_20250629_205208.html`
- **3D_Surface_Map**: `Várzea_Complex_North_3d_terrain_surface_20250629_205208.html`
- **Topographic_Contours_Map**: `Várzea_Complex_North_topographic_contours_20250629_205208.html`
...
**Supporting Evidence**:
- **DEM/LiDAR (50.6%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Northern várzea exploration
...
- Timestamp verification: 2025-06-29T20:52:08.794665

## AI-Generated Discovery Narrative

### The Digital Archaeological Investigation

**The Analysis Begins**: Using artificial intelligence and comprehensive data sources, we conducted a systematic archaeological investigation of the Amazon Basin. At coordinates -2.000000, -57.000000, our AI-powered system analyzed promising indicators requiring detailed assessment.
