...
- **Site Name**: Rondônia Extension South
- **Primary Coordinates**: -11.200000, -62.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Southern extension of Rondônia geoglyphs
- **Analysis Date**: 2025-06-29 18:51:32
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Rondônia Extension South represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (-11.200000, -62.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-11.209009, -62.009009) = **18.1%** probability
3. **North**: (-11.209009, -62.000000) = **16.7%** probability
4. **Northeast**: (-11.209009, -61.990991) = **16.1%** probability
5. **West**: (-11.200000, -62.009009) = **12.6%** probability
6. **East**: (-11.200000, -61.990991) = **15.4%** probability
7. **Southwest**: (-11.190991, -62.009009) = **19.8%** probability
8. **South**: (-11.190991, -62.000000) = **7.7%** probability
9. **Southeast**: (-11.190991, -61.990991) = **16.9%** probability
...
- **Cultural Context**: Southern extension of Rondônia geoglyphs
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Southern extension of Rondônia geoglyphs
- **Site Category**: discovery_target (discovery_potential priority)
...
- **Calculation**: 16,231 Hough lines → Amazon-adaptive scaling (baseline=15,000.0) → 0.768
- **Archaeological Interpretation**: Geometric signatures detected - 16,231 Hough lines indicate potential artificial modifications

**DEM/LiDAR Analysis**: 0.483 (Medium) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.483
...
**Hydro Management**: 0.827 (High) [WATER] REAL
...
- **Confidence Enhancement**: 2.893 → 1.000 (-0.141 adjustment)
...
- **Working Satellite URL**: https://sentinel-cogs.s3.us-west-2.amazonaws.com/sentinel-s2-l2a-cogs/20/L/PN/2024/6/S2A_20LPN_20240615_0_L2A/TCI.tif

## Generated Visualizations
- **Overview_Map_Map**: `Rondônia_Extension_South_archaeological_overview_map_20250629_185132.html`
- **Method_Map_Map**: `Rondônia_Extension_South_method_analysis_map_20250629_185132.html`
- **Evidence_Map_Map**: `Rondônia_Extension_South_evidence_documentation_map_20250629_185132.html`
- **3D_Surface_Map**: `Rondônia_Extension_South_3d_terrain_surface_20250629_185132.html`
- **Topographic_Contours_Map**: `Rondônia_Extension_South_topographic_contours_20250629_185132.html`
...
4. **Hydro Management (82.7%)**: Water management systems analyzed

**Supporting Evidence**:
- **DEM/LiDAR (48.3%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Southern extension of Rondônia geoglyphs
- **Pattern Analysis**: 16,231 geometric features analyzed
