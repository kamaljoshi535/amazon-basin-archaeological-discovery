...
- **Site Name**: Biodiversity Hotspot North
- **Primary Coordinates**: 0.000000, -65.000000 (Selected from archaeological literature)
- **Coordinate Source**: Grid analysis
- **Ground Truth Validation**: Validated against Northern biodiversity hotspot
- **Analysis Date**: 2025-06-29 21:16:16
- **Archaeological Probability**: 0.444 (44.4%)
- **Classification**: DISCOVERY

### Coordinate Selection Process & 9-Point Analysis
**Why This Coordinate**: Biodiversity Hotspot North represents a discovery_target site selected using our multi-method analysis system.

**Site Category**: discovery_target - discovery_potential priority

**ALL 9 COORDINATES ANALYZED** (3x3 Grid, 1km Resolution):
1. **Primary Site**: (0.000000, -65.000000) = **44.4%** probability - **DISCOVERY**
2. **Northwest**: (-0.009009, -65.009009) = **18.1%** probability
3. **North**: (-0.009009, -65.000000) = **16.7%** probability
4. **Northeast**: (-0.009009, -64.990991) = **16.1%** probability
5. **West**: (0.000000, -65.009009) = **12.7%** probability
6. **East**: (0.000000, -64.990991) = **15.5%** probability
7. **Southwest**: (0.009009, -65.009009) = **19.8%** probability
8. **South**: (0.009009, -65.000000) = **7.7%** probability
9. **Southeast**: (0.009009, -64.990991) = **16.9%** probability
...
- **Cultural Context**: Northern biodiversity hotspot
- **Archaeological Evidence**: Unknown - expansion target
- **Historical Significance**: Northern biodiversity hotspot
- **Site Category**: discovery_target (discovery_potential priority)
...
- **Calculation**: 16,699 Hough lines → Amazon-adaptive scaling (baseline=15,000.0) → 0.769
- **Archaeological Interpretation**: Geometric signatures detected - 16,699 Hough lines indicate potential artificial modifications

**DEM/LiDAR Analysis**: 0.453 (Medium) [REAL]
- *Analyzes elevation patterns for artificial landscape modifications and settlement indicators*
- **Calculation**: 2 DEM features detected → topographic analysis → 0.453
...
**Spectral Analysis**: 0.267 (Low) [REAL]
...
**Spatial Analysis**: 0.583 (High) [REAL]
...
- **Confidence Enhancement**: 2.937 → 1.000 (+0.109 adjustment)
...
- **Working Satellite URL**: https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/MODIS_Terra_CorrectedReflectance_TrueColor/default/2024-07-01/250m/6/32/20.jpg

## Generated Visualizations
- **Overview_Map_Map**: `Biodiversity_Hotspot_North_archaeological_overview_map_20250629_211616.html`
- **Method_Map_Map**: `Biodiversity_Hotspot_North_method_analysis_map_20250629_211616.html`
- **Evidence_Map_Map**: `Biodiversity_Hotspot_North_evidence_documentation_map_20250629_211616.html`
- **3D_Surface_Map**: `Biodiversity_Hotspot_North_3d_terrain_surface_20250629_211616.html`
- **Topographic_Contours_Map**: `Biodiversity_Hotspot_North_topographic_contours_20250629_211616.html`
...
2. **Spatial Analysis (58.3%)**: Organized patterns identified
...
**Supporting Evidence**:
- **DEM/LiDAR (45.3%)**: Topographic modifications support analysis
...
**Key Findings**:
- **Cultural Significance**: Northern biodiversity hotspot
- **Pattern Analysis**: 16,699 geometric features analyzed
